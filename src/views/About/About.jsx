    ...
    <main className="bg-black text-white">
        ...
        <div className="col-sm-12 col-md-4 col-lg-4 d-flex justify-content-center align-items-center">
          <section id="who-we-are">
            <div className="about-who-we-are-intro text-center p-2">
              ...
              <h2 className="about-who-we-are-description text-danger">
                WHO WE ARE...
              </h2>
              <p>
                It all began 30 years because Jerry Pop saw the need and decided
                to act on it. First camp had 24 attendees and a handful of
                coaches in a park.... blah, blah, blah..
              </p>
              It grew to as many as 300 high school player participants,
              receiving instruction, exposure, and sharing of the intimate
              details of what it takes to play at the next level from the top
        ...
        <div className="col-sm-12 col-md-4 col-lg-4 d-flex justify-content-center align-items-center">
          <section id="what-we-do">
            <div className="about-what-we-do-intro text-center p-2">
              <h6 className="testimonials">
                PROVIDING EXPOSURE TO STUDENT-ATHLETES...
              </h6>

              <h2 className="about-what-we-do-description text-danger">
                WHAT WE DO...
              </h2>
              <p>
                How the camp has evolved over the years to include the top
                programs in the country, and how we have been able to provide
                exposure to student-athletes who would not have had the
                opportunity otherwise. What can they expect to walk away with...
                participants & parent. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Eos animi voluptatum explicabo provident
                excepturi, dolorum aperiam, ullam corrupti enim deleniti atque
                porro earum commodi consectetur sit voluptate facere repellat
                delectus.
              </p>
            </div>
          </section>
        ...
        <div className="col-sm-12 col-md-4 col-lg-4 d-flex justify-content-center align-items-center">
          <section id="why-we-do-it">
            <div className="about-why-we-do-it-intro text-center p-2">
              ...
              <h2 className="about-why-we-do-it-description text-danger">
                WHY WE DO IT...
              </h2>
              <p>
                What drives us to do what we do... for the love of the game, for
                the love of the kids, for the love of the competition and for
                the love of assisting a player, find their perfect fit as they
                move into adulthood. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Eos animi voluptatum explicabo provident
                excepturi, dolorum aperiam, ullam corrupti enim deleniti atque
                porro earum commodi consectetur sit voluptate facere repellat
                delectus.
      ...
      <section id="about-our-values">
        <div className="about-our-values-intro text-center p-2">
          <h6 className="testimonials">
            PRINCIPLES & BELIEFS THAT SHAPE OUR IDENITY....
          </h6>

          <h2 className="about-our-values-description text-danger">
            WHY WE DO IT...
          </h2>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos animi
            voluptatum explicabo provident excepturi, dolorum aperiam, ullam
            corrupti enim deleniti atque porro earum commodi consectetur sit
            voluptate facere repellat delectus.
          </p>
        </div>
      </section>
      <br></br>
      ...
      <section id="testimonials">
          ...
          <div className="home-testimonial-intro text-center">
            <h6 className="testimonials">
            ...
            <p>
              ...
              testimonials reflect the impact we've had on individuals' lives
              and showcaseS the quality of the athlete developed through our
              ability to offer opportunity, through exposure. Let their words
              paint a picture of the exceptional opportunities we strive to
              create."
            </p>
          </div>
            ...
            <div className="row d-flex justify-content-center align-items-center p-4">
              <h6 className="testimonials text-center text-danger">
